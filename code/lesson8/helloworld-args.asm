...
_start: 
    ...
    pop     edi             ; first value on the stack is the number of arguments
    
nextArg:
    cmp     edi, 0H         ; check to see if we have any arguments left
    ...
    dec		edi             ; decrease edi (number of arguments left) by 1
